...
class TestSteel:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: Steel) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: Steel) -> None:
    ...
    def test_copy(self, client: Steel) -> None:
        copied = client.copy()
        assert id(copied) != id(client)

    def test_copy_default_options(self, client: Steel) -> None:
    ...
    def test_copy_default_headers(self) -> None:
        client = Steel(base_url=base_url, _strict_response_validation=True, default_headers={"X-Foo": "bar"})
    ...
    def test_copy_default_query(self) -> None:
        client = Steel(base_url=base_url, _strict_response_validation=True, default_query={"foo": "bar"})
    ...
    def test_copy_signature(self, client: Steel) -> None:
    ...
    def test_copy_build_request(self, client: Steel) -> None:
    ...
    def test_request_timeout(self, client: Steel) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_client_timeout_option(self) -> None:
        client = Steel(base_url=base_url, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_http_client_timeout_option(self) -> None:
        ...
        with httpx.Client(timeout=None) as http_client:
            client = Steel(base_url=base_url, _strict_response_validation=True, http_client=http_client)
    ...
    async def test_invalid_http_client(self) -> None:
        with pytest.raises(TypeError, match="Invalid `http_client` arg"):
            async with httpx.AsyncClient() as http_client:
                Steel(base_url=base_url, _strict_response_validation=True, http_client=cast(Any, http_client))

    def test_default_headers_option(self) -> None:
        test_client = Steel(base_url=base_url, _strict_response_validation=True, default_headers={"X-Foo": "bar"})
    ...
    def test_default_query_option(self) -> None:
        client = Steel(base_url=base_url, _strict_response_validation=True, default_query={"query_param": "bar"})
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        url = httpx.URL(request.url)
    ...
    def test_hardcoded_query_params_in_url(self, client: Steel) -> None:
    ...
    def test_request_extra_json(self, client: Steel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: Steel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: Steel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: Steel) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: Steel) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_non_application_json_content_type_for_json_data(self, respx_mock: MockRouter, client: Steel) -> None:
        """
    ...
    def test_base_url_setter(self) -> None:
        client = Steel(base_url="https://example.com/from_init", _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(STEEL_BASE_URL="http://localhost:5000/from/env"):
            client = Steel(_strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Steel(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True),
            Steel(
    ...
    def test_base_url_trailing_slash(self, client: Steel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Steel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Steel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = Steel(base_url=base_url, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: Steel) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Steel(base_url=base_url, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Steel(base_url=base_url, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        non_strict_client = Steel(base_url=base_url, _strict_response_validation=False)
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: Steel
    ) -> None:
    ...
    @mock.patch("steel._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_omit_retry_count_header(self, client: Steel, failures_before_success: int, respx_mock: MockRouter) -> None:
        client = client.with_options(max_retries=4)
    ...
    def test_overwrite_retry_count_header(
        self, client: Steel, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: Steel) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: Steel) -> None:
...
class TestAsyncSteel:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncSteel) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncSteel) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncSteel) -> None:
        copied = async_client.copy()
        assert id(copied) != id(async_client)

    def test_copy_default_options(self, async_client: AsyncSteel) -> None:
        # options that have a default are overridden correctly
    ...
    async def test_copy_default_headers(self) -> None:
        client = AsyncSteel(base_url=base_url, _strict_response_validation=True, default_headers={"X-Foo": "bar"})
        assert client.default_headers["X-Foo"] == "bar"
    ...
    async def test_copy_default_query(self) -> None:
        client = AsyncSteel(base_url=base_url, _strict_response_validation=True, default_query={"foo": "bar"})
        assert _get_params(client)["foo"] == "bar"
    ...
    def test_copy_signature(self, async_client: AsyncSteel) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncSteel) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncSteel) -> None:
    ...
    async def test_client_timeout_option(self) -> None:
        client = AsyncSteel(base_url=base_url, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    async def test_http_client_timeout_option(self) -> None:
        ...
        async with httpx.AsyncClient(timeout=None) as http_client:
            client = AsyncSteel(base_url=base_url, _strict_response_validation=True, http_client=http_client)
    ...
    def test_invalid_http_client(self) -> None:
        with pytest.raises(TypeError, match="Invalid `http_client` arg"):
            with httpx.Client() as http_client:
                AsyncSteel(base_url=base_url, _strict_response_validation=True, http_client=cast(Any, http_client))

    async def test_default_headers_option(self) -> None:
        test_client = AsyncSteel(base_url=base_url, _strict_response_validation=True, default_headers={"X-Foo": "bar"})
        request = test_client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("x-foo") == "bar"
        assert request.headers.get("x-stainless-lang") == "python"

        test_client2 = AsyncSteel(
            base_url=base_url,
            _strict_response_validation=True,
            default_headers={
                "X-Foo": "stainless",
    ...
    async def test_default_query_option(self) -> None:
        client = AsyncSteel(base_url=base_url, _strict_response_validation=True, default_query={"query_param": "bar"})
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        url = httpx.URL(request.url)
        assert dict(url.params) == {"query_param": "bar"}
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncSteel) -> None:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncSteel) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_union_response_different_types(self, respx_mock: MockRouter, async_client: AsyncSteel) -> None:
        """Union of objects with the same field name using a different type"""
    ...
    async def test_base_url_setter(self) -> None:
        client = AsyncSteel(base_url="https://example.com/from_init", _strict_response_validation=True)
        assert client.base_url == "https://example.com/from_init/"
    ...
    async def test_base_url_env(self) -> None:
        with update_env(STEEL_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncSteel(_strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            AsyncSteel(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True),
            AsyncSteel(
                base_url="http://localhost:5000/custom/path/",
                _strict_response_validation=True,
    ...
    async def test_base_url_trailing_slash(self, client: AsyncSteel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncSteel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncSteel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncSteel(base_url=base_url, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_client_response_validation_error(self, respx_mock: MockRouter, async_client: AsyncSteel) -> None:
        class Model(BaseModel):
            foo: str
    ...
    async def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            AsyncSteel(base_url=base_url, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncSteel(base_url=base_url, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        non_strict_client = AsyncSteel(base_url=base_url, _strict_response_validation=False)
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncSteel
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncSteel, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncSteel) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncSteel) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
