...
class TestScrape:
    ...
    def test_method_create(self, client: Steel) -> None:
        scrape = client.api.sdk.scrape.create(
    ...
    def test_raw_response_create(self, client: Steel) -> None:
        response = client.api.sdk.scrape.with_raw_response.create(
            url="https://example.com",
        )
    ...
    def test_streaming_response_create(self, client: Steel) -> None:
        with client.api.sdk.scrape.with_streaming_response.create(
            url="https://example.com",
        ) as response:
...
class TestAsyncScrape:
    ...
    async def test_method_create(self, async_client: AsyncSteel) -> None:
        scrape = await async_client.api.sdk.scrape.create(
            url="https://example.com",
        )
        assert_matches_type(object, scrape, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncSteel) -> None:
        response = await async_client.api.sdk.scrape.with_raw_response.create(
            url="https://example.com",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncSteel) -> None:
        async with async_client.api.sdk.scrape.with_streaming_response.create(
            url="https://example.com",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
