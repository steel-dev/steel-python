...
[![PyPI version](https://img.shields.io/pypi/v/steel.svg)](https://pypi.org/project/steel/)
...
pip install git+ssh://git@github.com/0xnenlabs/steel-python.git
```

> [!NOTE]
> Once this package is [published to PyPI](https://app.stainlessapi.com/docs/guides/publish), this will become: `pip install --pre steel`
...
These methods return an [`APIResponse`](https://github.com/0xnenlabs/steel-python/tree/main/src/steel/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/0xnenlabs/steel-python/tree/main/src/steel/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/0xnenlabs/steel-python/issues) with questions, bugs, or suggestions.
